...
def _reduce_grad(state, handle) -> None:
    ...
    """
    from torch.distributed.fsdp._runtime_utils import _FSDPState, _get_reduce_scatter_tensors, _accumulate_sharded_grad, _post_reduce_grad_callback, _div_if_needed
